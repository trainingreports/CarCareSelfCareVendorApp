...
class HomeSelfCareService extends React.Component {
    ...
    renderItem = ({ item }) => {
        ...
        return (
            <TouchableOpacity onPress={() => { navigation.navigate("SelfCareServiceDetails")}}>
                        ...
                        <View style={{ width: '76%', marginStart: 10, marginEnd: 10 }}>
                            <View style={styles.buttonContainer}>
                                ...
                                <TouchableOpacity style={{borderRadius: 4,}}
                                 onPress={() => { navigation.navigate("SelfCareServiceDetails")}}>
                                    <Image
                                        style={{
                                            width: 26,
                                            height: 26,
            ...
            <ScrollView>
                <View style={styles.container}>
                    ...
                    <View style={styles.buttonContainer}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('AddSelfCareService')
        }>
                            <Image
                                style={{
                                    width: 22,
