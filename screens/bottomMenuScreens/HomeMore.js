        ...
        <View style={styles.container}>
          ...
          <View style={styles.rawContainer}>
            <Image
              style={styles.icon}
              resizeMode={"contain"}
              source={require("../../assets/13.1-4-6-More/bank_account.png")}
            />
            <TouchableOpacity
              style={styles.label}
              onPress={() => navigation.navigate("AddBankAccountStack")}
            >
          ...
          <View style={styles.rawContainer}>
            <Image
              style={styles.icon}
              resizeMode={"contain"}
              source={require("../../assets/13.1-4-6-More/payment_history.png")}
            />
            <TouchableOpacity
              style={styles.label}
              onPress={() => navigation.navigate("PaymentActivity1")}
            >
          ...
          <View style={styles.rawContainer}>
            <Image
              style={styles.icon}
              resizeMode={"contain"}
              source={require("../../assets/13.1-4-6-More/notifications.png")}
            />
            <TouchableOpacity
              style={styles.label}
          ...
          <View style={styles.rawContainer}>
            <Image
              style={styles.icon}
              resizeMode={"contain"}
              source={require("../../assets/13.1-4-6-More/settings.png")}
            />
            <TouchableOpacity
              style={styles.label}
          ...
          <View style={styles.rawContainer}>
            <Image
              style={styles.icon}
              resizeMode={"contain"}
              source={require("../../assets/13.1-4-6-More/terms_services.png")}
            />
            <TouchableOpacity
              style={styles.label}
          ...
          <View style={styles.rawContainer}>
            <Image
              style={styles.icon}
              resizeMode={"contain"}
              source={require("../../assets/13.1-4-6-More/rate_us.png")}
            />
            <TouchableOpacity
              style={styles.label}
              //onPress={() => navigation.navigate('Setting')}
          ...
          <View style={styles.rawContainer}>
            <Image
              style={styles.icon}
              resizeMode={"contain"}
              source={require("../../assets/13.1-4-6-More/help_feedback.png")}
            />
            <TouchableOpacity
              style={styles.label}
              //onPress={() => navigation.navigate('Setting')}
