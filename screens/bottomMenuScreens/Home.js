      ...
      >
        <View style={styles.item}>
          <View style={styles.buttonContainer}>
            <Text style={{ width: "50%", color: "#999999", fontSize: 12 }}>
              {" "}
              Booking ID - 45763{" "}
            </Text>
            <Text
          ...
          <View style={styles.buttonContainer}>
            ...
            <View style={{ width: "84%", marginStart: 10 }}>
              <View style={styles.buttonContainer}>
                ...
                <Text
                  style={{ width: "50%", textAlign: "right", color: "#999999" }}
                >
                  {" "}
                  STATUS{" "}
                </Text>
              ...
              <View style={styles.buttonContainer}>
                <Text style={{ width: "50%", color: "#999999" }}>
                  +91 9458974385
                </Text>
                <View
                  style={{
          ...
          <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                navigation.navigate("BookingDetailsStack");
              }}
            >
              <Text
                style={{
