      ...
      >
        ...
        >
          <View style={{ width: "46%", marginStart: 10 }}>
            ...
            <Text
              style={{ width: "80%", fontWeight: "bold", color: "#FFFFFF" }}
            >
              {item.code}
            </Text>
          </View>
          ...
          >
            ...
            />
            <Text
              style={{ fontSize: 34, fontWeight: "bold", color: "#00C8E4" }}
            >
              {item.discount}
            </Text>
            <Text
        ...
        >
          <Text style={{ width: "50%", color: "#333333", fontWeight: "bold" }}>
            {" "}
            {item.no_of_user}{" "}
          </Text>
          <Text style={{ width: "50%", color: "#333333", fontWeight: "bold" }}>
        ...
        >
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("GenerateOfferCode", {
                edit: true,
                item: item
              })
            }
          ...
          <TouchableOpacity onPress={deleteOffer} style={styles.buttonStyle}>
            <View
              style={{
                flexDirection: "row",
                justifyContent: "center",
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        ...
        >
          <TouchableOpacity
            onPress={() => navigation.navigate("GenerateOfferCode")}
          >
            <Text
              style={{
                textAlign: "center",
