  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={{ width: "98%", color: "#999999", fontSize: 12 }}>
          {" "}
          Booking ID - 45763{" "}
        </Text>
        <Text
          style={{ width: "98%", color: "#999999", fontSize: 12, marginTop: 4 }}
        >
          {" "}
        ...
        >
          <View style={styles.buttonContainer}>
            <Text
              style={{ width: "98%", color: "#00C8E4", fontWeight: "bold" }}
            >
              {" "}
              15 OCT 2020{" "}
            </Text>
        ...
        >
          {" "}
          B-109, External Information Department , PO Box 17, Sharjah, UAE{" "}
        </Text>
