...
class EmpAbility extends React.Component {
    ...
    render() {
        return (
            <ScrollView>
                <Text style={{ fontSize: 16, marginLeft: 10, marginVertical: 20, fontWeight: "bold", opacity: 0.5 }}>DAYS AVAILABILITY</Text>
                <Calendar
                    ...
                    markedDates={{
                        ...
                        '2020-12-17': { disabled: true, startingDay: true, color: 'red', endingDay: true, textColor:'red' }
                    }}
                />
