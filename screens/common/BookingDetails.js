    ...
    return (
      <ScrollView>
        <View style={styles.container}>
          ...
          <Text style={{ width: '96%', color: '#999999', fontSize: 12, marginTop: 8 }}> Booking ID - 45763 </Text>
          <Text style={{ width: '96%', color: '#999999', fontSize: 12, marginTop: 4 }}> 15 August 2020, 05:30 PM </Text>
          ...
          <View style={{
            ...
            <View style={styles.buttonContainer}>
              <Text style={{ width: '50%', color: '#00C8E4', fontWeight: 'bold' }}> 15 OCT 2020 </Text>
              <Text style={{ width: '50%', color: '#00C8E4', fontWeight: 'bold', textAlign: 'right' }}> Thursday </Text>
            </View>
